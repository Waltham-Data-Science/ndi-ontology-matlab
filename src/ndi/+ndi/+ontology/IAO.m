...
%   Inherits from ndi.ontology and implements lookupTermOrID for IAO.
    ...
    methods
        ...
        function [id, name, definition, synonyms] = lookupTermOrID(obj, term_or_id_or_name)
            % LOOKUPTERMORID - Looks up a term in the Information Artifact Ontology (IAO) by ID or name.
            %
            ...
            %   functionality for the IAO ontology using the EBI OLS API via
            ...
            %   after the 'IAO:' prefix has been removed (e.g., '0000070' or 'document').
            %
            ...
            % Define ontology specifics for IAO
            ontology_prefix = 'IAO';
            ontology_name_ols = 'iao';
            ...
            try
                ...
                baseME = MException('ndi:ontology:IAO:PreprocessingError', ...
                     'Error preprocessing IAO lookup input "%s".', term_or_id_or_name);
            ...
            try
                ...
                baseME = MException('ndi:ontology:IAO:LookupFailed', ...
                     'IAO lookup failed for %s.', lookup_type_msg);
                baseME = addCause(baseME, ME);
                throw(baseME);
            end
